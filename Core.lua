		...
		optionsTab = {
			...
			args = {
				...
				useHPM = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.useHPMoverHPCT
					end,
					set = function(info, val)
						hsw.db.global.useHPMoverHPCT = val
						addon:UpdateDisplayLabels()
				...
				useVersDR = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.useVersDR
					end,
					set = function(info, val)
						hsw.db.global.useVersDR = val
						addon:UpdateDisplayLabels()
						addon:UpdateDisplayStats()
					end
				},
				useCritResurg = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.useCritResurg
					end,
					set = function(info, val)
						hsw.db.global.useCritResurg = val
						addon:UpdateDisplayLabels()
						addon:UpdateDisplayStats()
					end
				},
				excludeBigCDs = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.excludeRaidHealingCooldowns
					end,
					set = function(info, val)
						hsw.db.global.excludeRaidHealingCooldowns = val
					end
				},
				headerUI = {
					name = "UI Settings",
				...
				showFrame = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.alwaysShow
					end,
					set = function(info, val)
						hsw.db.global.alwaysShow = val
				...
				frameLocked = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.frameLocked
					end,
					set = function(info, val)
				...
				frameWidth = {
					...
					step = 1,
					get = function(info)
						return hsw.db.global.frameWidth
					end,
					set = function(info, val)
				...
				fontStr = {
					...
					get = function(info)
						return hsw.db.global.fontStr
					end,
					set = function(info, val)
						hsw.db.global.fontStr = val
						addon:AdjustFonts()
					end
				},
				fontColor = {
					...
					order = 15,
					get = function(info)
						return hsw.db.global.fontColor.r, hsw.db.global.fontColor.g, hsw.db.global.fontColor.b, hsw.db.global.fontColor.a
					end,
				...
				enabledAlways = {
					...
					width = "full",
					get = function(info)
						return hsw.db.global.alwaysEnabled
					end,
					set = function(info, val)
						hsw.db.global.alwaysEnabled = val
						addon:AdjustVisibility()
					end
				},
				enabledInNormalDungeons = {
					...
					get = function(info)
						return hsw.db.global.enabledInNormalDungeons
					end,
					set = function(info, val)
						hsw.db.global.enabledInNormalDungeons = val
						addon:AdjustVisibility()
					end
				},
				enabledInHeroicDungeons = {
					...
					get = function(info)
						return hsw.db.global.enabledInHeroicDungeons
					end,
					set = function(info, val)
						hsw.db.global.enabledInHeroicDungeons = val
						addon:AdjustVisibility()
					end
				},
				enabledInMythicDungeons = {
					...
					get = function(info)
						return hsw.db.global.enabledInMythicDungeons
					end,
					set = function(info, val)
						hsw.db.global.enabledInMythicDungeons = val
						addon:AdjustVisibility()
					end
				},
				enabledInMythicPlusDungeons = {
					...
					get = function(info)
						return hsw.db.global.enabledInMythicPlusDungeons
					end,
					set = function(info, val)
						hsw.db.global.enabledInMythicPlusDungeons = val
						addon:AdjustVisibility()
					end
				},
				enabledInLfrRaids = {
					...
					get = function(info)
						return hsw.db.global.enabledInLfrRaids
					end,
					set = function(info, val)
						hsw.db.global.enabledInLfrRaids = val
						addon:AdjustVisibility()
					end
				},
				enabledInNormalRaids = {
					...
					get = function(info)
						return hsw.db.global.enabledInNormalRaids
					end,
					set = function(info, val)
						hsw.db.global.enabledInNormalRaids = val
						addon:AdjustVisibility()
					end
				},
				enabledInHeroicRaids = {
					...
					get = function(info)
						return hsw.db.global.enabledInHeroicRaids
					end,
					set = function(info, val)
						hsw.db.global.enabledInHeroicRaids = val
						addon:AdjustVisibility()
					end
				},
				enabledInMythicRaids = {
					...
					get = function(info)
						return hsw.db.global.enabledInMythicRaids
					end,
					set = function(info, val)
						hsw.db.global.enabledInMythicRaids = val
						addon:AdjustVisibility()
					end
				}
			}
...
function addon:BuildOptionsTableForHistorySegment(i)
	...
	OptionsBuilder:AddHeaderButton(
		"Pawn >>",
		"Export as Pawn String",
		function()
			historySelected = i
...
function addon:GetQELiveStringFromHistory()
	...
	return self:GetQELiveStringRaw(
		specid,
		h.Name,
		h.Realm,
		h.Region,
