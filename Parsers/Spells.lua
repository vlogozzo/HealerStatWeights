...
------------------------------------------------------------------------------]]
local function createSpellInfo(
	id,
	spellType,
	isIntScaled,
	isCritScaled,
...
addon.Druid.DoubleLifebloomHoT = 188550
...
createSpellInfo(addon.Druid.DoubleLifebloomHoT, SpellType.DRUID, T, T, T, T, T, T, T)
...
addon.Potion.SpiritualHealingPotion = 307192

addon.Racials = {}
addon.Racials.EmbraceOfAkunda = 292474

--todo: convert to new wep enchant
addon.Enchant = {}
...
createSpellInfo(addon.Potion.SpiritualHealingPotion, SpellType.SHARED, _, _, _, _, T, _, _)

--Trinkets todo:															I C H H V M L
...
addon.DrumsofDeathlyFerocityId = 309658

addon.PrimalRageId = 264667
addon.ArcaneIntellectId = 1459
addon.CelestialGuidance = 324748 --mainstat wep enchant
...
addon.BuffTracker:Track(addon.DrumsofDeathlyFerocityId)
...
addon.BuffTracker:Track(addon.CelestialGuidance)
addon.Spells = Spells
