...
--Azerite
createSpellInfo(addon.Azerite.BondedSouls, 				SpellType.SHARED,	_,T,T,_,T,_,T);
createSpellInfo(addon.Azerite.AncientsBulwark,			SpellType.SHARED,	_,T,_,_,T,_,_);
createSpellInfo(addon.Azerite.BlessedPortents,			SpellType.SHARED,	_,T,T,_,T,_,T);
createSpellInfo(addon.Azerite.Savior,					SpellType.SHARED,	_,T,_,_,T,_,T);
createSpellInfo(addon.Azerite.BracingChill,				SpellType.SHARED,	_,T,T,_,T,_,T);
createSpellInfo(addon.Azerite.ConcentratedMending,		SpellType.SHARED,	_,T,T,_,T,_,T);
...
createSpellInfo(addon.Azerite.LaserMatrix,				SpellType.SHARED,	_,T,T,_,T,_,T);
